<svelte:head>
	<title> Privacy Policy - Arlecchino </title>
</svelte:head>
...
<p>
	<b>Arlecchino</b> provides a bot for the Discord chat platform (the "Bot"), a website that serves as a dashboard (the "Site") and other related services (collectively, the "Service(s)") to its users ("you" or the "user(s)"). This privacy policy sets forth our policy with respect to information that is collected from visitors to the Site and users of the Bot and/or the Services.
</p>
...
<ul>
	<li> Users have given their consent for one or more specific purposes. <br />
